/** 
 * @file llsliderctrl.h
 * @brief VRSliderCtrl (based on LLSliderCtrl)
 *
...
#ifndef LL_VRSLIDERCTRL_H
#define LL_VRSLIDERCTRL_H
...
class VRSlider : public LLSlider {
public:
	struct Params : public LLInitParam::Block<Params, LLSlider::Params> {
		Optional<F32>	scale_value;
    Params() : scale_value("scale_value", 1.0f) {}
	};
  ...
  struct xy { S32 x, y; };
  xy down, hover;
  VRSlider(const Params&p) : LLSlider(p), mScaleValue(p.scale_value), mHorizontal(p.orientation() != "vertical") {}
	friend class LLUICtrlFactory;
};

class VRSliderCtrl: public LLF32UICtrl, public ll::ui::SearchableControl
{
public:
	struct Params : public LLInitParam::Block<Params, LLF32UICtrl::Params>
	{
		...
		Optional<VRSlider::Params>		slider_bar;
...
protected:
	VRSliderCtrl(const Params&);
	friend class LLUICtrlFactory;
public:
	virtual ~VRSliderCtrl();
