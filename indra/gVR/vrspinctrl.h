...
#ifndef LL_VRSPINCTRL_H
#define LL_VRSPINCTRL_H
...
protected:
	VRSpinCtrl(const Params&);
	friend class LLUICtrlFactory;
public:
	virtual ~VRSpinCtrl() {} // Children all cleaned up by default view destructor.
