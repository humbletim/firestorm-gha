...
function colout() { PYTHONPATH="$(pwd -W)/bin/.colout;\$PYTHONPATH" "`which python3`" -c 'import signal;setattr(signal,"SIGPIPE",signal.SIGFPE);import sys;sys.argv[0]="colout.py";__import__("colout").main()' "\$@" ; }
